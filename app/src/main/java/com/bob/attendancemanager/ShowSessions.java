...
public class ShowSessions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = new Database(this);  // Initialize with context
        sessions = database.getSessions(classID);  // Fetch sessions from the database
    ...
    protected void onResume() {
        super.onResume();
        sessions = database.getSessions(classID);  // Refresh the list of sessions
